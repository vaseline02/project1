...
if($_GET['goodsnm'])$add_where[]="ol.goodsnm ='".trim($_GET['goodsnm'])."' ";
if($_GET['deli_comp'])$add_where[]="ol.step in ('5','51')";
...
if($_GET){
	...
	$field="ol.*".$cfg_select_gcl.",(".$cfg_sum_gcl.") deli_stock";
	...
	foreach($res->results as $v){
		...
		//if($v['code1']!=$v['goodsnm'])$v['color']="style='background-color:red'";
