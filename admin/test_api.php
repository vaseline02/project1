...
/*
$mp_params ={  "OrderId": "",  "Retailer": "",  "BuyerInfo": {   "Name": "",   "Address": "",   "ZipCode": "", "City": "Roma",   "ISOcountry": "IT",   "Courier": "",   "Notes": "",   "TypeShipping": "Direct / Logistic",   "Identification1": "",   "Identification2": ""  }, "GoodsList": { "Good": [  { "ID": "", "Size": "", "Qty": "", "Price": "", "Currency": ""        }  ] } } ;
 */
...
$size="UNI";
$qty="1";
$price="71,72"; //2.71.72_125.00 *0.7(30% discount)=87.50, 87.50/1.22(VAT)=EUR 71.72   후에db에서 계산.
$currency="EUR";
...
array("ID"=>$goodsno, "Size"=>$size, "Qty"=>$qty, "Price"=>$price, "Currency"=>$currency )
)
)
);

tydebug(json_encode($mp_params));
...
$turl="http://atelier-hub.com/hub/GetOrderShippingInfo?orderID=2020MarThu000142";
$turl="http://atelier-hub.com/hub/GetOrderStatusByTs?date=20200319";
$turl="http://atelier-hub.com/hub/GoodsStockPointList";
tydebug('0a');
