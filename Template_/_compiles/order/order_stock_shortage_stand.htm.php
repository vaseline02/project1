<?php /* Template_ 2.2.8 2021/03/17 16:22:58 /www/html/ukk_test2/data/skin/order/order_stock_shortage_stand.htm 000010136 */ 
...
<table class="table table-bordered" >
	<tr>
		<th>입예수량초과</th>
		<td>
<?php if(is_array($TPL_R2=($TPL_VAR["over_stand_stock"]))&&!empty($TPL_R2)){foreach($TPL_R2 as $TPL_K2=>$TPL_V2){?>
			<div style="width:20%;margin:10px;display:inline-block;">
			<?php echo $TPL_K2?>( 주문수량:<?php echo $TPL_V2["cnt"]?>/입예수량:<?php echo $TPL_V2["s_cnt"]?> )
			</div>
<?php }}?>
		</td>
	</tr>
...
<?php }?> 
			...
			<td><a href="#1" onclick="popup('../goods/stock_in_pop.php?goodsno=<?php echo $TPL_V2["goodsno"]?>','stock_in_pop','1000','700')"><font <?php if($TPL_V2["cs_chk"]){?>color='blue'<?php }elseif($TPL_V2["cal_chk"]){?>color='red'<?php }?>><?php echo $TPL_V2["goodsnm"]?></font></a></td>
			...
			<td><?php echo $TPL_V2["cur_cnt"]?></td>
			<td><?php echo $TPL_V2["codeno_3"]?></td>
			<td><?php echo $TPL_V2["codeno_1"]?></td>
			<td><?php echo $TPL_V2["codeno_51"]?></td>
			<td><?php echo $TPL_V2["codeno_91"]?></td>
			<td><?php echo $TPL_V2["codeno_125"]?></td>
			...
			<td><?php echo $TPL_V2["codeno_130"]?></td>
