<?php /* Template_ 2.2.8 2020/11/11 09:22:16 /www/html/ukk_test2/data/skin/goods/stock_move2.htm 000009765 */ 
...
<table class="table table-bordered" >
    <tr>
		<th>재고이동</th>
        <td><div type="button" class="btn btn-sm btn-primary" onclick="popup('stock_move_excel_reg.php','stock_change_reg','1100','900')">엑셀등록팝업</div></td>
...
<?php if($GLOBALS["print_xls"]!= 1){?><td class="td_img" ><?php echo $TPL_V1["img_url"]?></td><?php }?>
                            <td class="text_type"><a href="#1" onclick="popup('stock_move_reg.php?no=<?php echo $TPL_V1["no"]?>','stock_move_reg','1100','900')"><?php echo $TPL_V1["goodsnm"]?></a></td>
