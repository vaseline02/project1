<?php /* Template_ 2.2.8 2020/08/26 08:34:57 /www/html/ukk_test/data/skin/goods/goods_info_overlap.htm 000016612 */ 
...
<?php if($TPL_rloop_1){foreach($TPL_VAR["rloop"] as $TPL_V1){?>
							<tr onclick="popup('cs_reg.php?ordno=<?php echo $TPL_V1["ordno"]?>&mall_no=<?php echo $TPL_V1["mall_no"]?>&order_seq=<?php echo $TPL_V1["no"]?>','','1100','900')">			
								<td><?php echo $TPL_V1["mall_name"]?></td>
